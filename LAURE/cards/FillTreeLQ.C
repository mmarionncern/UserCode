 {
   ...
   string repository="root://eoscms//eos/cms/store/user/mmarionn/Leptoquarks/LQ2012"; //MET/53Xv1 //root://eoscms//eos/cms/store/user/mmarionn/Leptoquarks/LQ2012/
...
//     Analyse.AddMCSample( "T_tchan"                ,                     "single-t",          0 );
